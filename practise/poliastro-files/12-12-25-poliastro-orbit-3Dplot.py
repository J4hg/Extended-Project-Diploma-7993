...
epoch = Time("2025-12-12 12:15", scale="utc") # sets the initial point in time to the current time/date
...
plotter.plot(moon_orbit, label="Moon Orbit")

# Save the interactive Plotly figure to HTML
plotter._figure.write_html("12-12-25-poliastro-orbit-3Dplot.html")
